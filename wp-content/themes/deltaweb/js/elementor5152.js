...
! function(e, t) {
    ...
    var a = {
        ...
        elementorSection: function(e) {
            ...
            (n = new ElementsKitSectionParallaxPlugin(a)).init(n)
        }
    };
    e(window).on("elementor/frontend/init", a.init), window.ElementsKitSectionParallaxPlugin = function(a) {
        var n = this,
            i = a.data("id"),
            l = Boolean(t.isEditMode()),
            o = e(window);
        e("body"), o.scrollTop(), o.height(), navigator.userAgent.match(/Version\/[\d\.]+.*Safari/), navigator.platform;
        n.init = function() {
            return n.setParallaxMulti(i), n.moveBg(i), !1
        }, n.setParallaxMulti = function(t) {
            var i, o = {},
                r = [];
            if (o = n.getOptions(t, "ekit_section_parallax_multi_items"), "yes" == (i = n.getOptions(t, "ekit_section_parallax_multi"))) {
                if (l) {
                    if (!o.hasOwnProperty("models") || 0 === Object.keys(o.models).length || "yes" != i) return;
                    o = o.models
                }
                if (a.addClass("elementskit-parallax-multi-container"), e.each(o, function(e, t) {
                        t.hasOwnProperty("attributes") && (t = t.attributes), r.push(t), n.pushElement(t), n.getSVG()
                    }), r.length < 0) return r;
        ...
        }, n.moveBg = function(e) {}, n.walkItem = function(e) {
            void 0 !== e.parallax_transform && void 0 !== e.parallax_transform_value && a.find(".elementor-repeater-item-" + e._id).magician({
                type: "scroll",
            ...
            TweenMax.to(a.find(".elementor-repeater-item-" + e._id), 1, {
            ...
            var n = null,
                i = {};
            return l ? !!window.elementor.hasOwnProperty("elements") && (!!(n = window.elementor.elements).models && (e.each(n.models, function(e, a) {
                t == a.id && (i = a.attributes.settings.attributes)
            }), !!i.hasOwnProperty(a) && i[a])) : (t = "section" + t, !(!window.elementskit_section_parallax_data || !window.elementskit_section_parallax_data.hasOwnProperty(t)) && (!!window.elementskit_section_parallax_data[t].hasOwnProperty(a) && window.elementskit_section_parallax_data[t][a]))
        }, n.pushElement = function(e) {
            var t = "ekit-section-parallax-mousemove ekit-section-parallax-layer elementor-repeater-item-" + e._id,
                n = "";
            "shape" == e.item_source && (e.image.url = window.elementskit_plugin_url + "assets/svg/" + e.shape + ".svg", t += " ekit-section-parallax-layer-shape", n = "shape-" + e.shape.replace(".svg", "")), 0 === a.find(".elementor-repeater-item-" + e._id).length && "" != e.image.url && a.prepend(`\n                        <div class="${t}" >\n                            <img class="elementskit-parallax-graphic ${n}" src="${e.image.url}"/>\n                        </div>\n                    `)
        }, n.getSVG = function() {
